...
namespace Offsets
{
	constexpr int32 GObjects          = 0x042AB770;
	constexpr int32 AppendString      = 0x00ECE1A0;
	constexpr int32 GNames            = 0x0426F480;
	constexpr int32 GWorld            = 0x043EE878;
	constexpr int32 ProcessEvent      = 0x010C5F00;
